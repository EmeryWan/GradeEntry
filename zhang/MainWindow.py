...
class RequestExcelInfo:
    def __init__(self):
        self.request_excel_object = None
        self.request_excel_name = None
        self.request_sheet_name = None
        self.request_sheet_all_col = None
        self.request_sheet_all_row = None
...
class Window(QMainWindow):
    ...
    def get_grade_info_list(self):
        ...
        print("win row ", row)
        col = str(int(colname_to_colnum(self.ui.comboBox_get_col.currentText())))
        print("win col ", col)
