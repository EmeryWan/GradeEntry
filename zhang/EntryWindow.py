...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_advance.setGeometry(QtCore.QRect(10, 510, 481, 81))
        self.groupBox_advance.setMouseTracking(False)
        self.groupBox_advance.setObjectName("groupBox_advance")
        self.pushButton = QtWidgets.QPushButton(self.groupBox_advance)
        self.pushButton.setGeometry(QtCore.QRect(50, 30, 371, 41))
        self.pushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton.setObjectName("pushButton")
        self.checkBox_advance = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_advance.setGeometry(QtCore.QRect(10, 480, 91, 27))
        ...
        self.groupBox_excel_file.setGeometry(QtCore.QRect(10, 10, 481, 331))
        ...
        self.groupBox_excel_info.setGeometry(QtCore.QRect(10, 190, 461, 141))
        self.groupBox_excel_info.setObjectName("groupBox_excel_info")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox_excel_info)
        self.layoutWidget.setGeometry(QtCore.QRect(50, 30, 363, 97))
        ...
        self.btn_start.setGeometry(QtCore.QRect(40, 380, 411, 41))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 350, 399, 21))
        ...
        self.btn_click_checkbox.setGeometry(QtCore.QRect(40, 430, 411, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "再次打开浏览器"))
        ...
        self.label.setText(_translate("MainWindow", "请选择第一个成绩所在的行列"))
